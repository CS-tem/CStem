...
CREATE (article_0:Article { id : 0, title : 'Training Region-based Object Detectors with Online Hard Example Mining', year : 2016, venue_id : 0, n_citations : 0 });
CREATE (article_1:Article { id : 1, title : 'NeRS: Neural Reflectance Surfaces for Sparse-View 3D Reconstruction in the Wild', year : 2021, venue_id : 1, n_citations : 0 });
CREATE (article_2:Article { id : 2, title : 'Actions ~ Transformations', year : 2016, venue_id : 0, n_citations : 0 });
CREATE (article_3:Article { id : 3, title : 'ViSER: Video Surface Embeddings for Articulated 3D Shape Reconstruction', year : 2021, venue_id : 1, n_citations : 0 });
CREATE (article_4:Article { id : 4, title : 'Learning to Segment Rigid Motions from Two Frames', year : 2021, venue_id : 0, n_citations : 0 });
...
CREATE (topic_2:Topic { id : 2, name : 'machine learning', n_articles : 0, n_authors : 0, n_citations : 0 });

CREATE (venue_0:Venue { id : 0, name : 'Conference on Computer Vision and Pattern Recognition', acronym : 'CVPR', type : 'Conference', avg_citations : 0, flexibility : 0 });
CREATE (venue_1:Venue { id : 1, name : 'Conference and Workshop on Neural Information Processing Systems', acronym : 'NeurIPS', type : 'Conference', avg_citations : 0, flexibility : 0 });
